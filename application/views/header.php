                    ...
                    <li class="has-sub-menu <?php echo ($page == 'games')?'selected':'';?>">
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li class="<?php echo ($page == 'games' && $pageType == 'nfl')?'active':'';?>">
                                        <a href="<?php echo site_url('games?type=nfl'); ?>"><img src="<?php echo base_url('assets/img/football_icon.png')?>">NFL</a>
                                    </li>
                                    <li class="<?php echo ($page == 'games' && $pageType == 'ncaaf')?'active':'';?>">
                                        <a href="<?php echo site_url('games?type=ncaaf'); ?>"><img src="<?php echo base_url('assets/img/icon_NFL.png')?>">NCAAF</a>
                                    </li>
                                    ...
                                    <li class="<?php echo ($page == 'games' && $pageType == 'ncaab')?'active':'';?>">
                                        <a href="<?php echo site_url('games?type=ncaab'); ?>"><img src="<?php echo base_url('assets/img/icon_NCAAM.png')?>">NCAAB</a>
                                    </li>
                                    ...
                                    <li class="<?php echo ($page == 'games' && $pageType == 'nhl')?'active':'';?>">
                                        <a href="<?php echo site_url('games?type=nhl'); ?>"><img src="<?php echo base_url('assets/img/football_icon.png')?>">NHL</a>
                                    </li>
                                    ...
                                    <li class="<?php echo ($page == 'games' && $pageType == 'mma')?'active':'';?>">
                                        <a href="<?php echo site_url('games?type=mma'); ?>"><img src="<?php echo base_url('assets/img/icon_MLB.png')?>">MMA</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    ...
                                    <li class="<?php echo ($page == 'picks' && $pageType == 'ncaaf')?'active':'';?>">
                                        <a href="<?php echo site_url('picks?type=ncaaf'); ?>"><img src="<?php echo base_url('assets/img/icon_NFL.png')?>">NCAAF</a>
                                    </li>
                                    ...
                                    <li class="<?php echo ($page == 'picks' && $pageType == 'ncaab')?'active':'';?>">
                                        <a href="<?php echo site_url('picks?type=ncaab'); ?>"><img src="<?php echo base_url('assets/img/icon_NCAAM.png')?>">NCAAB</a>
                                    </li>
